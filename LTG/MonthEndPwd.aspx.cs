...
namespace LTG
{
    public partial class MonthEndPwd : System.Web.UI.Page
    {
        ...
        protected void btnCreate_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                ...
                if (recordCount == 0)
                {
                    ...
                    qry = "INSERT INTO MonthEnd (Password,ModifiedDate,ModifiedBy) VALUES (@Password,getdate(),@ModifiedBy)";
                }
                else
                {
                    // Records exist, so update the existing user
                    qry = "UPDATE MonthEnd SET Password = @Password,ModifiedDate=getdate(),ModifiedBy=@ModifiedBy";
                }
