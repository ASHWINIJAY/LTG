...
namespace LTG
{
    public partial class CustomerEdit : System.Web.UI.Page
    {
        ...
        private void bindCustomer()
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                ...
                if (txtSearchContainer.Text != "")
                    qry += " where CustomerName like '%" + txtSearchContainer.Text + "%'";
        ...
        private  bool checkCustomer(string cusCode)
        {
            ...
            {
                con.Open();
                string qry = "Select * from Inbound where CustomerCode='" + cusCode + "'";
                SqlCommand cmd1 = new SqlCommand(qry, con);
                using (SqlDataAdapter da = new SqlDataAdapter(cmd1))
                {
                    DataTable dt = new DataTable();
        ...
        private void DeleteCustomer(string cusCode)
        {
            ...
            {
                con.Open();
                string qry = "delete  from Customers where CustomerCode='" + cusCode + "'";
                SqlCommand cmd1 = new SqlCommand(qry, con);
                ...
                qry = "Insert into AuditLogs([Table],Field,Custom,ModifiedByUserId,ModifiedByUserName,ModifiedByDate)values('Customers','Delete','Delete the customer: " + cusCode + " ','" + hdLoginId.Value + "','" + userName + "',getdate())";
                cmd1 = new SqlCommand(qry, con);
                cmd1.ExecuteNonQuery();
                Page.ClientScript.RegisterStartupScript(this.GetType(), "showalert", "alert('Customer deleted successfully.');", true);
        ...
        protected void grdCustomer_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "SelectImage")
                Response.Redirect("CustomerSetup.aspx?Code=" + customerCode);
            else
            {
                if(checkCustomer(customerCode))
                {
                    Page.ClientScript.RegisterStartupScript(this.GetType(), "showalert", "alert('You cannot delete as this Customer has already been used and has history');", true);
        ...
        private void ExportDivContentToExcel1()
        {
            ...
            using (ExcelPackage excel = new ExcelPackage())
            {
                ...
                // Add welcome line
                worksheet.Cells[1, 2].Value = "List of Customers";
