    ...
    public partial class Supervisor : System.Web.UI.Page
    {
        ...
        protected void btnCreate_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                ...
                string checkCountQry = "SELECT COUNT(*) FROM Supervisor";
                ...
                if (recordCount == 0)
                {
                    ...
                    qry = "INSERT INTO Supervisor (Password,ModifiedDate,ModifiedBy,ModifiedId) VALUES (@Password,getdate(),@ModifiedBy,@ModifiedId)";
                }
                else
                {
                    // Records exist, so update the existing user
                    qry = "UPDATE Supervisor SET Password = @Password,ModifiedDate=getdate(),ModifiedBy=@ModifiedBy,ModifiedId=@ModifiedId";
                }
