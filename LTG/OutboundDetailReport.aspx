<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OutboundDetailReport.aspx.cs" Inherits="LTG.OutboundDetailReport" %>
       ...
       <div id="divHeader" runat="server">
        ...
        <div>
          ...
          <asp:GridView ID="grdDetails" Width="100%" runat="server" HeaderStyle-BackColor="LightGray" OnRowCreated="grdDetails_RowCreated" OnDataBound="grdDetails_DataBound" AutoGenerateColumns="False">
           ...
           <asp:BoundField DataField="DocDate" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" HeaderText="GDN Date"/>
           ...
           <asp:BoundField DataField="ToDate" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" HeaderText="ToDate"/>
                  ...
                  <asp:BoundField DataField="QtyOut" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" ItemStyle-BackColor="#00B050" HeaderText="QtyOut"/>
              <asp:BoundField DataField="QtyOutRate" DataFormatString="{0:F2}" HeaderStyle-HorizontalAlign="Left" ItemStyle-BackColor="#00B050" ItemStyle-HorizontalAlign="Left" HeaderText="QtyOutRate"/>
           <asp:BoundField DataField="TotOutRate" DataFormatString="{0:F2}" HeaderStyle-HorizontalAlign="Left" ItemStyle-BackColor="#00B050" ItemStyle-HorizontalAlign="Left" HeaderText="TotQtyOutRate"/>
