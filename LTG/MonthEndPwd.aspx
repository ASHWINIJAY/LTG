<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="MonthEndPwd.aspx.cs" Inherits="LTG.MonthEndPwd" %>
    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <div class="col">
          ...
          <!-- Recent Activity -->
          <div class="card">
              <div id="divTest" runat="server" class="card-title" style="text-align:center;background-color: #4090ce;color:white">Month-End Password</div>
