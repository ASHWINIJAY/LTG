<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RGRNDetailReport.aspx.cs" Inherits="LTG.RGRNDetailReport" %>
        ...
        <div>
          ...
          <asp:GridView ID="grdDetails" Width="100%" runat="server" HeaderStyle-BackColor="LightGray" OnRowCreated="grdDetails_RowCreated" OnDataBound="grdDetails_DataBound" AutoGenerateColumns="False">
           ...
           <asp:BoundField DataField="ReturnDateTimeofScan" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" HeaderText="Returned Date"/>
              ...
              <asp:BoundField DataField="DateTimeofScan" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" HeaderText="Inbounded Date"/>
            <asp:BoundField DataField="Duration" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" ItemStyle-BackColor="#00B050" HeaderText="No of days"/>
                     ...
                     <asp:BoundField DataField="RGRN" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" ItemStyle-BackColor="#00B050" HeaderText="RGRN"/>
            <asp:BoundField DataField="GRN" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" ItemStyle-BackColor="#00B050" HeaderText="GRN"/>
                  ...
                  <asp:BoundField DataField="UnitInBoundCost" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" ItemStyle-BackColor="#00B050" HeaderText="Returned InBoundCost"/>
