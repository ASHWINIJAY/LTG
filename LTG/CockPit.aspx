<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="CockPit.aspx.cs" Inherits="LTG.CockPit" %>
            ...
            <ItemStyle HorizontalAlign="Center" />
                        ...
                        <asp:TemplateField HeaderText="Line#">
                         ...
                         <asp:TemplateField HeaderText="Bin">
                            <ItemTemplate>
                                <asp:Label ID="lblBin" runat="server" Text='<%# Eval("Bin") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
