...
namespace LTG
{
    public partial class ManagerBinCockPit : System.Web.UI.Page
    {
        ...
        private DataTable loadData()
        {
            ...
            SqlCommand cmd;
            con.Open();
            string qry = "select Distinct CountedBin as Bin,CustomerCode from BinAccuracyCount where Completed=1 and CountedBin<>ActualBin and MAllocatedTo is null";
        ...
        private void loadGrid()
        {
            ...
            SqlCommand cmd;
            con.Open();
            string qry = "select Distinct CountedBin as Bin,CustomerCode from BinAccuracyCount where Completed=1 and CountedBin<>ActualBin  and StockTakeCompleted is null and MAllocatedTo is null ";
            if (txtSearchContainer.Text != "")
                qry += " and (CountedBin like'" + txtSearchContainer.Text + "%')";
        ...
        private void loadBinGrid()
        {
          ...
          //  SaveCheckboxStates();
            ...
            string qry = "select Distinct CountedBin as Bin,CustomerCode from BinAccuracyCount where Completed=1 and CountedBin<>ActualBin and MAllocatedTo is null ";
            if (txtBins.Text != "")
                qry += " and (CountedBin like'" + txtBins.Text + "%')";
            txtBins.Text = "";
            cmd = new SqlCommand(qry, con);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataSet ds = new DataSet();
        ...
        protected void AllocateStock()
        {
            ...
            string query = "UPDATE BinAccuracyCount SET MAllocatedTo = @UserName,MAllocatedCompleted=1  WHERE CountedBin = @Bin";
