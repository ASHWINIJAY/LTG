<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PickedExceptionReport.aspx.cs" Inherits="LTG.PickedExceptionReport" %>
        ...
        <div>
          ...
          <asp:GridView ID="grdDetails" Width="100%" runat="server" HeaderStyle-BackColor="LightGray" OnRowCreated="grdDetails_RowCreated" OnDataBound="grdDetails_DataBound" AutoGenerateColumns="False">
           ...
           <asp:BoundField DataField="ToDate" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" HeaderText="ToDate"/>     
             ...
             <asp:BoundField DataField="Qty" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"  HeaderText="Qty Picked"/>
             
           <asp:BoundField DataField="InboundDate" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" HeaderText="Date Picked"/>
                     <asp:BoundField DataField="Loginname" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"  HeaderText="User Name"/>
             <asp:BoundField  HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"  HeaderText="GDN"/>
           <asp:BoundField DataField="Storeqty" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" HeaderText="Qty Out"/>
