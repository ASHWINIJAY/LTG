<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvoiceDetailReport.aspx.cs" Inherits="LTG.InvoiceDetailReport" %>
        ...
        <div class="col">
          ...
          <div class="card">
               <table class="storage-details-table">
                   <caption>This report displays the HUs that were inbounded within the selected period. </caption>
            <thead>
                <tr>
                    <th>Field</th>
                    <th>Description</th>
