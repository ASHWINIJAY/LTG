...
namespace LTG
{
    public partial class InitStockTakeAccuracy : System.Web.UI.Page
    {
        ...
        private bool ValidateStockMaster()
        {
            ...
            string validationQuery = "SELECT COUNT(*) FROM BinAccuracyMaster WHERE Completed = 0";
        ...
        private void loadGrid()
        {
            ...
            SqlCommand cmd;
            con.Open();
            string qry = "select * from vw_InitStockAccuracy";
        ...
        private void loadBinGrid()
        {
            ...
            SqlCommand cmd;
            con.Open();
            string qry = "select Distinct Bin,CustomerCode from vw_InitStockAccuracy ";
            if (txtBins.Text != "")
                qry += " where Bin like'" + txtBins.Text + "%'";
            txtBins.Text = "";
            cmd = new SqlCommand(qry, con);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataSet ds = new DataSet();
        ...
        private void save()
        {
            ...
            if (radFullStockTake.Checked)
                refno = "Full Stock Accuracy";
            // SQL Insert Query
            string query = "INSERT INTO BinAccuracyMaster (CustomerCode, ContainerId, Bin, Currentdate,NoofCount,Completed,CreatedBy,Refno) VALUES (@CustomerCode, @ContainerId, @Bin,getdate(),1,0,'" + userName + "','"+ refno +"')";
            ...
            ClientScript.RegisterStartupScript(this.GetType(), "alert", "alert('Stock Take Accuracy Initiated Successfully!');", true);
            loadGrid();
    }
        ...
        protected void radFullStockTake_CheckedChanged(object sender, EventArgs e)
        {
            ...
            btnReset.Text = "Initiate Full Stock Accuracy";
            loadGrid();
        }
        ...
        protected void btnConfirmCancel_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                ...
                string query3 = "Update BinAccuracyHistory set StockTakeCompleted=1 where RefNo is null;Update BinAccuracyCount set StockTakeCompleted=1;Delete From BinAccuracyMaster;Update BinCounterInstruction set StockTakeCompleted=1;";
        ...
        public void SendEmailWithAttachment()
        {
            ...
            string subject = "LTG - Stock Take Accuracy Cancelled";
            //string body = "This is the body of the email.";
            string body = "<b>Hello!  </b>, <br> <br>";
            body += "The ongoing stock take accuracy process successfully cancelled. ";
