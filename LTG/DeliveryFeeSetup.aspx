<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DeliveryFeeSetup.aspx.cs" Inherits="LTG.DeliveryFeeSetup" %>
      ...
      <div class="row">
        ...
        <div class="col">
          ...
          <div class="card">
               ...
               <h5 class="card-title" style="text-align:center;background-color: #4090ce;color:white">Delivery Fee</h5>
           <section class="section error-404 d-flex flex-column align-items-center justify-content-center">
                <div class="row g-3 needs-validation">
                    ...
                    <div class="col-12">
                      <label for="txtExistingFee" class="form-label">Existing WeekDays Delivery Fee</label>
                    ...
                    <div class="col-12">
                      <label for="txtNewFee" class="form-label">Enter WeekDays Delivery Fee</label>
                     <asp:TextBox id="txtNewFee" runat="server"  class="form-control"></asp:TextBox>
                        <asp:RequiredFieldValidator runat="server" id="RequiredFieldValidator1" ForeColor="OrangeRed" controltovalidate="txtNewFee" errormessage="Please enter a Delivery Fee!" />
                      
                    </div>
                     <div class="col-12">
                      <label for="txtExistingFee" class="form-label">Existing Saturday Delivery Fee</label>
                    ...
                    <div class="col-12">
                      <label for="txtNewFee" class="form-label">Enter Saturday Delivery Fee</label>
                     <asp:TextBox id="txtSaturday" runat="server" ValidationGroup="TimeSlot"  class="form-control"></asp:TextBox>
                        <asp:RequiredFieldValidator runat="server" id="RequiredFieldValidator2" ForeColor="OrangeRed" controltovalidate="txtSaturday" errormessage="Please enter a Saturday Delivery Fee!" />
                      
                    </div>
                     <div class="col-12">
                      <label for="txtExistingFee" class="form-label">Existing Sunday Delivery Fee</label>
                    ...
                    <div class="col-12">
                      <label for="txtNewFee" class="form-label">Enter Sunday Delivery Fee</label>
                     <asp:TextBox id="txtSunday" runat="server" ValidationGroup="TimeSlot" class="form-control"></asp:TextBox>
                        <asp:RequiredFieldValidator runat="server" id="RequiredFieldValidator3" ForeColor="OrangeRed" controltovalidate="txtSunday" errormessage="Please enter a Sunday Delivery Fee!" />
