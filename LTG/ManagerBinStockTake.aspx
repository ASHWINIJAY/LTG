<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ManagerBinStockTake.aspx.cs" Inherits="LTG.ManagerBinStockTake" %>
     ...
     <style>
        ...
        .popup-overlay {
            ...
            z-index: 999;
             ...
             <script>
function myFunction() {
    var c = confirm("Are you sure complete to the process !");
    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <div class="col">
          ...
          <!-- Recent Activity -->
          <div class="card">
           <h5 class="card-title" style="text-align:center;background-color: #4090ce;color:white">Manager Stock Accuracy Capture</h5>

           <section class="section error-404 d-flex flex-column align-items-center justify-content-center">

                <div class="row">
                     <div class="col-12">
                      <label for="txtHU" class="form-label">Type Or Scan Bin </label>
                     <asp:TextBox id="txtBin" runat="server" ValidationGroup="TimeSlot7" AutoPostBack="false" ClientIDMode="Static" class="form-control"></asp:TextBox>
                        <asp:RequiredFieldValidator runat="server" id="RequiredFieldValidator3" controltovalidate="txtBin" ErrorMessage="Please type Bin Number" ForeColor="OrangeRed" />
                    </div>
                    <div class="col-12">
                      <label for="txtHU" class="form-label">Type Or Scan HU Number</label>
                     <asp:TextBox id="txtAddHU" runat="server" ValidationGroup="TimeSlot7" AutoPostBack="true" OnTextChanged="txtQty_TextChanged" ClientIDMode="Static" class="form-control"></asp:TextBox>
                     ...
                     <asp:TextBox id="txtQty" runat="server" AutoPostBack="true" Text="1" OnTextChanged="txtQty_TextChanged" ValidationGroup="TimeSlot" BackColor="#dfe8f0" ClientIDMode="Static" class="form-control"></asp:TextBox>
                  ...
                  <asp:Button ID="btrnViewPending" class="btn btn-primary" Visible="true"  OnClick="btrnViewPending_Click" ValidationGroup="TimeSlot8" Text="List of Bin's to count" BackColor="#bc623c" runat="server" />
                   <asp:Button ID="btnComplete" class="btn btn-primary" OnClick="btnComplete_Click" ValidationGroup="TimeSlot8" OnClientClick="return myFunction();" Text="Complete & move to next bin" BackColor="#518b8f" runat="server" />
      <asp:HiddenField ID="hfUserConfirmed" runat="server" />
                        <asp:HiddenField ID="hdnActualBin" runat="server" />
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Bin" HeaderText="Bin"  HeaderStyle-Width="57%" /> 
          ...
          <div class="card">
           ...
           <section class="section error-404 d-flex flex-column align-items-center justify-content-center">
                ...
                <Columns>
                     ...
                     <asp:BoundField DataField="Bin" HeaderText="Bin"  HeaderStyle-Width="80%" />
                    <asp:TemplateField>
            <ItemTemplate>
