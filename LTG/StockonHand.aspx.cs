...
namespace LTG
{
    public partial class StockonHand : System.Web.UI.Page
    {
        ...
        {
            Session["CustomerCode"] = ddlCustomer.SelectedIndex==0 ?"All" : ddlCustomer.SelectedValue;
            Session["CustomerName"] = ddlCustomer.SelectedIndex == 0 ? "All" : ddlCustomer.SelectedItem.Text;
            //string relativeUrl = "Invoice.aspx";
            string relativeUrl = "StockonhandReport.aspx";
