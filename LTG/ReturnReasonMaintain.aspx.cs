...
namespace LTG
{
    public partial class ReturnReasonMaintain : System.Web.UI.Page
    {
        ...
        private void bindCustomer()
        {
            ...
            {
                con.Open();
                string qry = "Select * from ReturnReason";
                if (txtSearchContainer.Text != "")
                    qry += " where ReturnCode like '%" + txtSearchContainer.Text + "%' or ReturnReason like '%" + txtSearchContainer.Text + "%'";
        ...
        protected void grdCustomer_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "SelectImage")
                Response.Redirect("ReturnReason.aspx?Code=" + customerCode);
            else
            {
        ...
        private void ExportDivContentToExcel1()
        {
            ...
            grdCustomer.Columns[5].Visible = false;
            ...
            using (ExcelPackage excel = new ExcelPackage())
            {
                ...
                // Add welcome line
                worksheet.Cells[1, 2].Value = "List of Return Reason";
                ...
                Response.AddHeader("content-disposition", "attachment; filename=Bins.xlsx");
                grdCustomer.Columns[4].Visible = true;
                grdCustomer.Columns[5].Visible = true;
        ...
        private void DeleteCustomer(string cusCode)
        {
            ...
            {
                con.Open();
                string qry = "delete  from ReturnReason where ReturnCode='" + cusCode + "'";
                SqlCommand cmd1 = new SqlCommand(qry, con);
                ...
                qry = "Insert into AuditLogs([Table],Field,Custom,ModifiedByUserId,ModifiedByUserName,ModifiedByDate)values('ReturnReason','Deleted','Deleted the ReturnReason: " + cusCode + " ','" + hdLoginId.Value + "','" + userName + "',getdate())";
                cmd1 = new SqlCommand(qry, con);
                cmd1.ExecuteNonQuery();
                Page.ClientScript.RegisterStartupScript(this.GetType(), "showalert", "alert('Reason deleted successfully.');", true);
