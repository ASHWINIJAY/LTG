<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PickedDetailReport.aspx.cs" Inherits="LTG.PickedDetailReport" %>
       ...
       <div id="divHeader" runat="server">
        ...
        <div>
          ...
          <asp:GridView ID="grdDetails" Width="100%" runat="server" HeaderStyle-BackColor="LightGray" OnRowCreated="grdDetails_RowCreated" OnDataBound="grdDetails_DataBound" AutoGenerateColumns="False">
           ...
           <asp:BoundField DataField="DocDate" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" HeaderText="Picked Date"/>
           ...
           <asp:BoundField DataField="ToDate" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" HeaderText="ToDate"/>
                     ...
                     <asp:BoundField DataField="GRN" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" ItemStyle-BackColor="#00B050" HeaderText="Picking Number"/>
            
                  <asp:BoundField DataField="QtyIn" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" ItemStyle-BackColor="#00B050" HeaderText="Picked Qty"/>
             <asp:BoundField DataField="Status" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" ItemStyle-BackColor="#00B050" HeaderText="Status"/>
