<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ContainerAdj.aspx.cs" Inherits="LTG.ContainerAdj" %>
        ...
        <div class="col">
         ...
         <!-- End Recent Activity -->
             <div class="card" id="divScan" visible="true" runat="server">
               ...
               <div class="card-title" id="divHeader" runat="server" style="text-align:center;background-color: #4090ce;color:white">Change Container to Another Customer</div>
