<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="StorageFee.aspx.cs" Inherits="LTG.StorageFee" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <main id="main" class="main">
        ...
        <script>
function myFunction() {
    return confirm(" The fee change that you are about to make will have change all costs on the current warehouse quantities for this customer Where the quantity is greater than 0 are you sure you want to save these changes ?");
}
        </script>
