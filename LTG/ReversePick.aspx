<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ReversePick.aspx.cs" Inherits="LTG.ReversePick" %>
          ...
          <div class="card">
           ...
           <section class="section error-404 d-flex flex-column align-items-center justify-content-center">
                <div class="row">
                     ...
                     <asp:TextBox id="txtSearchContainer" runat="server" placeholder="Search PickupNumber..." ValidationGroup="TimeSlot21" AutoPostBack="true" OnTextChanged="txtSearchContainer_TextChanged"  ClientIDMode="Static" style="padding-top: 14px;" Width="70%"></asp:TextBox>
                ...
                <Columns>
                     ...
                     <asp:BoundField DataField="PickNumber" HeaderText="PickupNumber"  HeaderStyle-Width="30%" />
                    <asp:BoundField DataField="OutboundDate" HeaderText="Picked Date" DataFormatString="{0:dd/MMM/yyyy}" HtmlEncode="False"  HeaderStyle-Width="30%" />
                    <asp:TemplateField>
            <ItemTemplate>
        ...
        <div class="col">
         ...
         <!-- End Recent Activity -->
             <div class="card" id="divScan" visible="true" runat="server">
               ...
               <div class="card-title" id="divHeader" runat="server" style="text-align:center;background-color: #4090ce;color:white">Picked HU Reverse Process</div>
           <div class="section error-404 d-flex flex-column align-items-center justify-content-center">
                <div class="row g-3 needs-validation">
                     ...
                     <div class="col-12" style="display:none;">
                         <asp:Button ID="btnBrowse" class="btn btn-primary" OnClick="btnBrowse_Click" ValidationGroup="2" Text="Select PickupNumber From List" runat="server" />
                       </div>
                    <div class="col-12" style="display:none;">
                      <label for="txtGDN" class="form-label">Type Pickup Number</label>
                     <asp:TextBox id="txtGDN" runat="server" ValidationGroup="TimeSlot" AutoPostBack="true" OnTextChanged="txtGDN_TextChanged"  ClientIDMode="Static" class="form-control"></asp:TextBox>
                        <asp:RequiredFieldValidator runat="server" id="reqName" controltovalidate="txtGDN" ErrorMessage="Please type Pickup Number" ForeColor="OrangeRed" />
                    </div>
                     <div class="col-12">
                      <label for="txtRetHU" class="form-label">Scan/Type HU</label>
                     <asp:TextBox id="txtRetHU" runat="server" ValidationGroup="TimeSlot" AutoPostBack="true" OnTextChanged="txtRetHU_TextChanged"  ClientIDMode="Static" class="form-control"></asp:TextBox>
                        <asp:RequiredFieldValidator runat="server" id="RequiredFieldValidator1" controltovalidate="txtRetHU" ErrorMessage="Please type HU Number" ForeColor="OrangeRed" />
                    </div>
                     <div class="col-9">
                    ...
                    <div class="col-2" style="margin-top: -9px;">
                     ...
                     <div class="col-12">
                      <label for="txtGRN" class="form-label">RPICKN</label>
                ...
                <Columns>
                   ...
                   <asp:BoundField DataField="PickNumber" HeaderText="Picking Number"  HeaderStyle-Width="45%" />
                </Columns>
                            <HeaderStyle BackColor="#4090ce" ForeColor="White" />
            </asp:GridView>
                         </div>
