<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="InitStockTakeAccuracy.aspx.cs" Inherits="LTG.InitStockTakeAccuracy" %>
    ...
    <section class="section dashboard">
           ...
           <section class="section error-404 d-flex flex-column align-items-center justify-content-center">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                     ...
                     <asp:TextBox id="txtBins" runat="server" ValidationGroup="TimeSlot21" AutoPostBack="true" OnTextChanged="txtBins_TextChanged"  ClientIDMode="Static" style="padding-top: 14px;" Placeholder="Enter Bin" Width="70%"></asp:TextBox>
      ...
      <div class="row">
           ...
           <section class="section error-404 d-flex flex-column align-items-center justify-content-center">
                <div class="row">
                   ...
                   <div class="col-12" style="margin-top: -9px;">
                    ...
                    <div class="col-6" style="margin-top: 3px;">
                         <asp:Button ID="btnSaveDate" class="btn btn-secondary" OnClick="btnSaveDate_Click" ValidationGroup="TimeSlot12" OnClientClick="return confirm('Are you sure you want to initiate stock take process?');" Text="Initiate" runat="server" />
        ...
        <div class="col">
          ...
          <!-- Recent Activity -->
          <div class="card">
              <h5 class="card-title" style="text-align:center;background-color: #4090ce;color:white">Initiate Stock Accuracy</h5>
           <section class="section error-404 d-flex flex-column align-items-center justify-content-center">
                <div class="row g-3 needs-validation">
                  ...
                  <div class="col-6">
                      <asp:RadioButton ID="radCycle" OnCheckedChanged="radCycle_CheckedChanged" AutoPostBack="true" runat="server" Text="Initiate for selected Bin only (Cycle Count)" Checked="false" GroupName="Test" />
                    </div>  <div class="col-6"> <asp:RadioButton ID="radFullStockTake" runat="server" OnCheckedChanged="radFullStockTake_CheckedChanged" AutoPostBack="true" Text="Initiate for All Bins" Checked="true" GroupName="Test" />

                      </div>
                    <div class="col-12">

                       <asp:Button ID="btnBrowseBin" runat="server" CssClass="btn btn-custom" style="background-color:#12b6fc;" Text="Select Bin for Cycle Count" Visible="false" OnClick="btnBrowseBin_Click" />
                        
                       <asp:Button ID="btnReset" runat="server" CssClass="btn btn-custom" Text="Initiate Full Stock Accuracy " OnClick="btnReset_Click" />
               <asp:Button ID="btnConfirm" runat="server" OnClick="btnConfirm_Click" Style="display:none;" />
                         <asp:Button ID="btnCancelOngoingStock" runat="server" CssClass="btn btn-custom" style="background-color:#12b6fc;" Text="Cancel Ongoing Stock Take" Visible="true" OnClick="btnCancelOngoingStock_Click" />
