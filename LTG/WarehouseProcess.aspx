<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="WarehouseProcess.aspx.cs" Inherits="LTG.WarehouseProcess" %>
      ...
      <div class="row">
        ...
        <div class="col">
          ...
          <div class="card" id="divCustomer" runat="server">
               ...
               <h5 class="card-title" style="text-align:center;background-color: #4090ce;color:white">Binning Process</h5>
           <div class="section error-404 d-flex flex-column align-items-center justify-content-center">
                <div class="row g-3 needs-validation">
                    <div class="col-9">
                        <label for="txtContainer" class="form-label">Binning Date</label>
                    </div>
                    ...
                    <asp:DropDownList ID ="ddlCustomer" runat="server" class="form-select">
                     ...
                     <div class="col-12">
                      <label for="txtGRN" class="form-label">BINNING</label>
             ...
             <div class="card" id="divScan" visible="false" runat="server">
               ...
               <div class="card-title" id="divHeader" runat="server" style="text-align:center;background-color: #4090ce;color:white">Binning Process</div>
           <div class="section error-404 d-flex flex-column align-items-center justify-content-center">
                <div class="row g-3 needs-validation">
                    ...
                    <div class="col-12">
                     ...
                     <asp:TextBox id="txtBin" runat="server" ValidationGroup="TimeSlot" Text="" autocomplete="off" OnTextChanged="txtBin_TextChanged1" AutoPostBack="true"  ClientIDMode="Static" class="form-control"></asp:TextBox>
                        <asp:RequiredFieldValidator runat="server" id="RequiredFieldValidator2" controltovalidate="txtBin" ErrorMessage="Please type/scan bin" ForeColor="OrangeRed" />
                    </div>
                     <div class="col-12">
                      <label for="txtHU" class="form-label">Scan or Type HU Number</label>
                     <asp:TextBox id="txtHU" runat="server" ValidationGroup="TimeSlot" autocomplete="off"  ClientIDMode="Static" OnTextChanged="txtHU_TextChanged" AutoPostBack="true" class="form-control"></asp:TextBox>
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Bin" HeaderText="Bin"  HeaderStyle-Width="30%" />
                    <asp:BoundField DataField="QtyIn" HeaderText="Qty"  HeaderStyle-Width="10%" />
                </Columns>
