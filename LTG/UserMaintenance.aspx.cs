    ...
    public partial class UserMaintenance : System.Web.UI.Page
    {
        ...
        private void bindCustomer()
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                ...
                if (txtSearchContainer.Text != "")
                    qry += " where Username like '%" + txtSearchContainer.Text + "%'";
        ...
        private void ExportDivContentToExcel1()
        {
            ...
            using (ExcelPackage excel = new ExcelPackage())
            {
                ...
                // Add welcome line
                worksheet.Cells[1, 2].Value = "List of Users";
                ...
                grdCustomer.Columns[7].Visible = true;
                grdCustomer.Columns[5].Visible = true;
                grdCustomer.Columns[6].Visible = true;
        ...
        protected void grdCustomer_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if(e.CommandName== "SelectRole")
                Response.Redirect("UserRoles.aspx?Code=" + customerCode);
            else if (e.CommandName == "SelectImage")
            Response.Redirect("UserCreation.aspx?Code=" + customerCode);
            else
            {
        ...
        private void DeleteCustomer(string cusCode)
        {
            ...
            {
                con.Open();
                string qry = "delete  from Users where UserName='" + cusCode + "'";
                SqlCommand cmd1 = new SqlCommand(qry, con);
                ...
                qry = "Insert into AuditLogs([Table],Field,Custom,ModifiedByUserId,ModifiedByUserName,ModifiedByDate)values('Users','Delete','Delete the user: " + cusCode + " ','" + hdLoginId.Value + "','" + userName + "',getdate())";
