<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="InvoiceReport.aspx.cs" Inherits="LTG.InvoiceReport" %>
    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <div class="col">
          ...
          <!-- Recent Activity -->
          <div class="card">
              <h5 class="card-title" style="text-align:center;background-color: #4090ce;color:white">HU Tracking Report(Details)</h5>
