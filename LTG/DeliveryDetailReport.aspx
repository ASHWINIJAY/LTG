<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeliveryDetailReport.aspx.cs" Inherits="LTG.DeliveryDetailReport" %>
        ...
        <div>
          ...
          <asp:GridView ID="grdDetails" Width="100%" runat="server" HeaderStyle-BackColor="LightGray" OnRowCreated="grdDetails_RowCreated" OnDataBound="grdDetails_DataBound" AutoGenerateColumns="False">
           ...
           <asp:BoundField DataField="ToDate" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" HeaderText="ToDate"/>
                     ...
                     <asp:BoundField DataField="GDN" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" ItemStyle-BackColor="#00B050" HeaderText="GDN"/>
            
                  <asp:BoundField DataField="DelvOut" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" ItemStyle-BackColor="#00B050" HeaderText="DelvOut"/>
              <asp:BoundField DataField="DelvOutRate" DataFormatString="{0:F2}" HeaderStyle-HorizontalAlign="Left" ItemStyle-BackColor="#00B050" ItemStyle-HorizontalAlign="Left" HeaderText="DelvOutRate"/>
           <asp:BoundField DataField="TotDelvRate" DataFormatString="{0:F2}" HeaderStyle-HorizontalAlign="Left" ItemStyle-BackColor="#00B050" ItemStyle-HorizontalAlign="Left" HeaderText="TotDelvRate"/>
                     <asp:BoundField DataField="DeliveryFee" DataFormatString="{0:F3}" HeaderStyle-HorizontalAlign="Left" ItemStyle-BackColor="#00B050" ItemStyle-HorizontalAlign="Left" HeaderText="DeliveryFee"/>
