<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="StockTake.aspx.cs" Inherits="LTG.StockTake" %>
    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <div class="col">
          ...
          <!-- Recent Activity -->
          <div class="card">
           <h5 class="card-title" style="text-align:center;background-color: #4090ce;color:white">Stock Take Capture</h5>
           ...
           <section class="section error-404 d-flex flex-column align-items-center justify-content-center">
                ...
                <div class="row">
                  ...
                  <asp:Button ID="btrnViewPending" class="btn btn-primary" OnClick="btrnViewPending_Click" ValidationGroup="TimeSlot8" Text="List of HU to count" BackColor="#bc623c" runat="server" />
