<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RPICKDetailReport.aspx.cs" Inherits="LTG.RPICKDetailReport" %>
        ...
        <div>
          ...
          <asp:GridView ID="grdDetails" Width="100%" runat="server" HeaderStyle-BackColor="LightGray" OnRowCreated="grdDetails_RowCreated" OnDataBound="grdDetails_DataBound" AutoGenerateColumns="False">
           ...
           <asp:BoundField DataField="ReturnDateTimeofScan" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" HeaderText="Returned Date"/>
              ...
              <asp:BoundField DataField="DateTimeofScan" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" HeaderText="Picked Date"/>
            <asp:BoundField DataField="Duration" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" ItemStyle-BackColor="#00B050" HeaderText="No of days"/>
                     ...
                     <asp:BoundField DataField="RPICKN" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" ItemStyle-BackColor="#00B050" HeaderText="RPICKN"/>
            <asp:BoundField DataField="PickNumber" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" ItemStyle-BackColor="#00B050" HeaderText="PickNumber"/>
                  <asp:BoundField DataField="Qty" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Right" ItemStyle-BackColor="#00B050" HeaderText="Returned Qty"/>
