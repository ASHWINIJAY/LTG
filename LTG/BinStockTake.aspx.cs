...
namespace LTG
{
    public partial class BinStockTake : System.Web.UI.Page
    {
        ...
        private void GenerateGRN()
        {
            ...
            {
                con.Open();
                string qry = "select count(distinct(STN))+1 FROM BinAccuracyHistory";
                ...
                using (SqlDataAdapter da = new SqlDataAdapter(cmd1))
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        txtGRN.Text = "STAN-" + dtMonth + "-" + output;
        ...
        protected void FillInbound()
        {
            ...
            {
                con.Open();
                string qry = "SELECT  distinct Bin  FROM BinCounterInstruction where isnull(saved,0) = 0 and isnull(Completed,0)=0 and StockTakeCompleted is null and  AllocatedTo='" + hdUserName.Value + "'";
                if (txtStock.Text != "")
                    qry += " and Bin like '%" + txtStock.Text + "%' ";
        ...
        protected void FillGrid()
        {
            ...
            {
                con.Open();
                string qry = "SELECT CountedBin as  Bin, HU,STN  FROM BinAccuracyCount where isnull(saved,0) = 1 and isnull(Completed,0)=0 and  CountedBy='" + hdUserName.Value + "'";
        ...
        private void save()
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                ...
                string qry = "Insert into BinAccuracyCount(STN,HU,ActualBin,CountedBin,Saved,Completed,CountedBy,CountedDate)values('" + txtGRN.Text + "','" + txtAddHU.Text + "','" + hdnActualBin.Value + "','" + txtBin.Text + "',1,0,'" + userName + "',getdate())";
                SqlCommand cmd1 = new SqlCommand(qry, con);
                cmd1.ExecuteNonQuery();
                qry = "Insert into BinAccuracyHistory(STN,HU,ActualBin,CountedBin,Saved,Completed,CountedBy,CountedDate)values('" + txtGRN.Text + "','" + txtAddHU.Text + "','" + hdnActualBin.Value + "','" + txtBin.Text + "',1,0,'" + userName + "',getdate())";
        ...
        protected void btnComplete_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                ...
                string qry = "UPDATE BinCounterInstruction SET Completed = 1 WHERE Bin = @HU;Update BinAccuracyCount SET Completed = 1 WHERE CountedBin = @HU ";
