<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeFile="ManagerCockPit.aspx.cs" Inherits="LTG.ManagerCockPit" %>
    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <div class="col">
          ...
          <!-- Recent Activity -->
          <div class="card">
              <h5 class="card-title" style="text-align:center;background-color: #4090ce;color:white">Allocate Stock Take By Bin</h5>
           <section class="section error-404 d-flex flex-column align-items-center justify-content-center">
                <div class="row g-3 needs-validation">
                  ...
                  <div class="col-12">
                     ...
                     <asp:TextBox id="txtSearchContainer" runat="server" ValidationGroup="TimeSlot21" placeholder="Enter Bincode or HU" AutoPostBack="true" OnTextChanged="txtSearchContainer_TextChanged"  ClientIDMode="Static" style="padding-top: 14px;" Width="70%"></asp:TextBox>
                    ...
                    <div class="col-12">
                       <asp:Button ID="btnReset" runat="server" CssClass="btn btn-custom" style="background-color:#518f56;" Text="Click here to allocate" OnClick="btnReset_Click" />
                         <asp:Button ID="btnShowAllocate" runat="server" CssClass="btn btn-custom" Text="View Selected HU's" OnClick="btnShowAllocate_Click" />
...
<asp:HiddenField ID="hfUserConfirmed" runat="server" />
                    ...
                    <div class="col-12">
                         <asp:GridView ID="grdBin" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered table-hover" 
                              EmptyDataText="No Data Found" OnRowDataBound="grdBin_RowDataBound" DataKeyNames="HU" HeaderStyle-CssClass="bg-dark text-light">
                    <Columns>
