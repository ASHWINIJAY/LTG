<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ReverseGRN.aspx.cs" Inherits="LTG.ReverseGRN" %>
          ...
          <div class="card">
           ...
           <section class="section error-404 d-flex flex-column align-items-center justify-content-center">
                <div class="row">
                     ...
                     <asp:TextBox id="txtSearchContainer" runat="server" placeholder="Search GRN..." ValidationGroup="TimeSlot21" AutoPostBack="true" OnTextChanged="txtSearchContainer_TextChanged"  ClientIDMode="Static" style="padding-top: 14px;" Width="70%"></asp:TextBox>
                ...
                <Columns>
                     ...
                     <asp:BoundField DataField="GRN" HeaderText="GRN"  HeaderStyle-Width="30%" />
                    <asp:BoundField DataField="OutboundDate" HeaderText="GRN Date" DataFormatString="{0:dd/MMM/yyyy}" HtmlEncode="False"  HeaderStyle-Width="30%" />
                    <asp:TemplateField>
            <ItemTemplate>
        ...
        <div class="col">
         ...
         <!-- End Recent Activity -->
             <div class="card" id="divScan" visible="true" runat="server">
               ...
               <div class="card-title" id="divHeader" runat="server" style="text-align:center;background-color: #4090ce;color:white">GRN Reverse Process</div>
           <div class="section error-404 d-flex flex-column align-items-center justify-content-center">
                <div class="row g-3 needs-validation">
                     ...
                     <div class="col-12">
                         <asp:Button ID="btnBrowse" class="btn btn-primary" OnClick="btnBrowse_Click" ValidationGroup="2" Text="Select GRN From List" runat="server" />
                       </div>
                    <div class="col-12">
                      <label for="txtGDN" class="form-label">Type GRN Number</label>
                     <asp:TextBox id="txtGDN" runat="server" ValidationGroup="TimeSlot" AutoPostBack="true" OnTextChanged="txtGDN_TextChanged"  ClientIDMode="Static" class="form-control"></asp:TextBox>
                        <asp:RequiredFieldValidator runat="server" id="reqName" controltovalidate="txtGDN" ErrorMessage="Please type GRN Number" ForeColor="OrangeRed" />
                    </div>
                     <div class="col-9">
                    ...
                    <div class="col-2" style="margin-top: -9px;">
                     ...
                     <div class="col-12">
                      <label for="txtGRN" class="form-label">RGRN</label>
                ...
                <Columns>
                   ...
                   <asp:BoundField DataField="GRN" HeaderText="GRN"  HeaderStyle-Width="45%" />
                </Columns>
                            <HeaderStyle BackColor="#4090ce" ForeColor="White" />
            </asp:GridView>
                         </div>
