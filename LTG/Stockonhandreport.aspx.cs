...
namespace LTG
{
    public partial class Stockonhandreport : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    lblHeader.Text = "Stockonhand Report - for " + Session["CustomerName"].ToString() + " Customer";
        ...
        private void bindInvoice()
        {
            ...
            {
                con.Open();
                string qry = "Select * from vw_InitStockTake";

                if (Session["CustomerCode"].ToString() != "All")
                    qry += " where CustomerCode='" + Session["CustomerCode"].ToString() + "'";
