<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RGDNDetailReport.aspx.cs" Inherits="LTG.RGDNDetailReport" %>
        ...
        <div>
          ...
          <asp:GridView ID="grdDetails" Width="100%" runat="server" HeaderStyle-BackColor="LightGray" OnRowCreated="grdDetails_RowCreated" OnDataBound="grdDetails_DataBound" AutoGenerateColumns="False">
           ...
           <asp:BoundField DataField="ReturnDateTimeofScan" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" HeaderText="Returned Date"/>
              ...
              <asp:BoundField DataField="DateTimeofScan" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" HeaderText="Delivery Date"/>
            <asp:BoundField DataField="Duration" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" ItemStyle-BackColor="#00B050" HeaderText="No of days"/>
                     ...
                     <asp:BoundField DataField="RGDN" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" ItemStyle-BackColor="#00B050" HeaderText="RGDN"/>
            <asp:BoundField DataField="GDN" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" ItemStyle-BackColor="#00B050" HeaderText="GDN"/>
                  ...
                  <asp:BoundField DataField="UnitOutBoundCost" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" ItemStyle-BackColor="#00B050" HeaderText="Returned OutBoundCost"/>
