...
namespace LTG
{
    public partial class OutBoundFee : System.Web.UI.Page
    {
        ...
        protected void btnCreate_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                ...
                if (txtNewFee.Text == "")
                {
                    Page.ClientScript.RegisterStartupScript(this.GetType(), "showalert", "alert('Please enter the outbound fee');", true);
                    return;
                }
                qry = "Insert into FeeMaster(BranchId,BranchName,FeeType,Fee,Active,ValidFrom,CreatedBy,CreatedDate,CustomerCode)values('" + ddlBranch.SelectedValue + "','" + ddlBranch.SelectedItem.Text + "','OutBound','" + txtNewFee.Text + "',1,getdate(),'" + userName + "',getdate(),'" + ddlCustomer.SelectedValue + "')";
