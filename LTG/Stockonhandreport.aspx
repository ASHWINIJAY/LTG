<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Stockonhandreport.aspx.cs" Inherits="LTG.Stockonhandreport" %>
      ...
      <div id="divHeader" runat="server">
        ...
        <div>
          ...
          <asp:GridView ID="grdDetails" Width="100%" runat="server" HeaderStyle-BackColor="LightGray" OnRowCreated="grdDetails_RowCreated" OnDataBound="grdDetails_DataBound" AutoGenerateColumns="False">
            ...
            <asp:BoundField DataField="GRN" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" ItemStyle-BackColor="#FFFF00" HeaderText="GRN"/>
            <asp:BoundField DataField="CustomerCode" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" ItemStyle-BackColor="#FFFF00" HeaderText="Customer"/>
              ...
              <asp:BoundField DataField="Qty" HeaderStyle-HorizontalAlign="Left" ItemStyle-BackColor="#00B050" ItemStyle-HorizontalAlign="Left" HeaderText="QtyOnHand"/>
