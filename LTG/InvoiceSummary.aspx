<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvoiceSummary.aspx.cs" Inherits="LTG.InvoiceSummary" %>
        ...
        <div class="col">
          ...
          <div class="card">
               <table class="storage-details-table">
                   <caption>This report displays the containers that were inbounded within the selected period. </caption>
            <thead>
                <tr>
                    <th>Field</th>
                    <th>Description</th>
