    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <asp:CheckBox id="CheckBoxTransporterMaintenance" runat="server" Text="Transporter Maintenance" style="padding-left:50px;" />
                     ...
                     <hr />
                     <div class="card-title" id="div9" runat="server" style="text-align:left;background-color: transparent;color:black;padding-top:1px;padding-bottom:1px;">Delivery Note <asp:CheckBox id="chkDeliveryAll" AutoPostBack="true" OnCheckedChanged="chkDeliveryAll_CheckedChanged" runat="server" /></div>
                    <div class="col-12">
