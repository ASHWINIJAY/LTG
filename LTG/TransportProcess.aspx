<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="TransportProcess.aspx.cs" Inherits="LTG.TransportProcess" %>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <script>
function myFunction() {
  confirm("Are you sure complete the Transport Scan !");
        }
      ...
      <div class="row">
        ...
        <div class="col">
          ...
          <div class="card" id="divCustomer" runat="server">
               ...
               <h5 class="card-title" style="text-align:center;background-color: #4090ce;color:white">Transport Process</h5>
           <div class="section error-404 d-flex flex-column align-items-center justify-content-center">
             ...
             <div class="card" id="divScan" visible="false" runat="server">
               ...
               <div class="card-title" id="divHeader" runat="server" style="text-align:center;background-color: #4090ce;color:white">Transport Process</div>
           <div class="section error-404 d-flex flex-column align-items-center justify-content-center">
                <div class="row g-3 needs-validation">
                   ...
                   <asp:Button ID="btnBack" class="btn btn-secondary" OnClick="btnBack_Click" ValidationGroup="2" OnClientClick="return confirm('Are you sure you want to go back to the previous screen?');" Text="Back" runat="server" />
                                             <asp:Button ID="btnCancel" class="btn btn-danger" ValidationGroup="2" OnClientClick="return confirm('Are you sure to cancel the Transport process?');" OnClick="btnCancel_Click1" Text="Cancel" runat="server" />    
                   </div>
