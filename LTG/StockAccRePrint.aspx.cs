...
namespace LTG
{
    public partial class StockAccRePrint : System.Web.UI.Page
    {
        ...
        protected void btnComplete_Click(object sender, EventArgs e)
        {
            ...
            {
                string script = "alert(\"Refnumber is not available\");";
            ...
            string relativeUrl = "Delivery.aspx?source=3&id=" + hdnBin.Value;
        ...
        private bool checkBin()
        {
            ...
            {
                con.Open();
                string qry = "Select Id from StockConfirmReport where Id='" + txtBin.Text + "'";
        ...
        protected void FillGrid()
        {
            ...
            {
                con.Open();
                string qry = " select distinct top 1000 Id,  CreatedDate FROM StockConfirmReport Where Id like'STAH%' ";
                if (txtSearchContainer.Text != "")
                    qry += " or Id like '%" + txtSearchContainer.Text + "%'";
