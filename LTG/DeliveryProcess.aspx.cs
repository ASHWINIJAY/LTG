...
namespace LTG
{
    public partial class DeliveryProcess : System.Web.UI.Page
    {
        ...
        private string GenerateSeqn()
        {
            ...
            {
                con.Open();
                string qry = "select count(distinct(PartNumber))+1 FROM Delivery where PartNumber='" + txtSpare.Text + "'";
                SqlCommand cmd1 = new SqlCommand(qry, con);
                using (SqlDataAdapter da = new SqlDataAdapter(cmd1))
                {
                    DataTable dt = new DataTable();
        ...
        private bool CheckDuplicate()
        {
            ...
            {
                con.Open();
                string qry = "select PartNumber FROM Delivery where PartNumber='" + txtSpare.Text + "'";
                SqlCommand cmd1 = new SqlCommand(qry, con);
                using (SqlDataAdapter da = new SqlDataAdapter(cmd1))
                {
                    DataTable dt = new DataTable();
        ...
        private int partNumberTotal()
        {
            ...
            {
                con.Open();
                string qry = "select count(PartNumber) FROM Delivery where PartNumber='" + txtSpare.Text + "'";
                SqlCommand cmd1 = new SqlCommand(qry, con);
                using (SqlDataAdapter da = new SqlDataAdapter(cmd1))
                {
                    DataTable dt = new DataTable();
        ...
        private void GenerateGRN()
        {
            ...
            {
                con.Open();
                string qry = "select count(distinct(GRN))+1 FROM Delivery";
                SqlCommand cmd1 = new SqlCommand(qry, con);
                using (SqlDataAdapter da = new SqlDataAdapter(cmd1))
                {
                    DataTable dt = new DataTable();
        ...
        protected void btnCusNext_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (hdnDeliveryFee.Value == "")
            {
                ...
                {
                    script = script.Replace("Delivery", "saturday Delivery");
                }
                if (hdnFeeDays.Value == "2")
                {
                    script = script.Replace("Delivery", "sunday Delivery");
                }
                ScriptManager.RegisterStartupScript(this, GetType(),
                                      "ServerControlScript", script, true);
            ...
            divHeader.InnerText = "Delivery Process for - " + ddlCustomer.SelectedItem.Text;
        ...
        private bool checkRefNo()
        {
            ...
            {
                con.Open();
                string qry = "Select * from Delivery where ContainerId='" + txtContainer.Text + "'";
                SqlCommand cmd1 = new SqlCommand(qry, con);
                using (SqlDataAdapter da = new SqlDataAdapter(cmd1))
                {
                    DataTable dt = new DataTable();
        ...
        private void save()
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                ...
                if (Convert.ToDateTime(txtDate.Text).ToString("dd/MMM/yyyy") == DateTime.Now.ToString("dd/MMM/yyyy"))
                    ...
                    qry = "Insert into Delivery(ContainerId,BranchId,BranchName,CustomerCode,CustomerName,HU,Qty,UnitDeliveryCost,TotalDeliveryCost,Loginname,DateTimeofScan,CreatedBy,CreatedDate,GRN,DefaultBin)values('" + txtContainer.Text + "'," + ddlBranch.SelectedValue + ",'" + ddlBranch.SelectedItem.Text + "','" + ddlCustomer.SelectedValue + "','" + ddlCustomer.SelectedItem.Text + "','" + txtHU.Text + "','" + txtQty.Text + "'," + hdnDeliveryFee.Value + "," + hdnDeliveryFee.Value + ",'" + userid + "','" + txtDate.Text + "','" + userName + "',getdate(),'" + txtGRN.Text + "','" + txtDefaultBin.Text + "')";
        ...
        private void saveAlP()
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                ...
                if (Convert.ToDateTime(txtDate.Text).ToString("dd/MMM/yyyy") == DateTime.Now.ToString("dd/MMM/yyyy"))
                    txtDate.Text = DateTime.Now.ToString("dd/MMM/yyyy HH:mm");
                qry = "Insert into Delivery(BarcodeBase64,PartNumber,PartQty,ContainerId,BranchId,BranchName,CustomerCode,CustomerName,HU,Qty,UnitDeliveryCost,TotalDeliveryCost,Loginname,DateTimeofScan,CreatedBy,CreatedDate,GRN,DefaultBin)values('" +barcode +"', '" + txtSpare.Text + "','" + txtALPQty.Text + "','" + txtContainer.Text + "'," + ddlBranch.SelectedValue + ",'" + ddlBranch.SelectedItem.Text + "','" + ddlCustomer.SelectedValue + "','" + ddlCustomer.SelectedItem.Text + "','" + txtHU.Text + "','" + txtQty.Text + "'," + hdnDeliveryFee.Value + "," + hdnDeliveryFee.Value + ",'" + userid + "','" + txtDate.Text + "','" + userName + "',getdate(),'" + txtGRN.Text + "','" + txtDefaultBin.Text + "')";
        ...
        protected void btnComplete_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                ...
                string qry = "Update Delivery set Completed=1 where GRN='" + txtGRN.Text + "'";
                SqlCommand cmd1 = new SqlCommand(qry, con);
                cmd1.ExecuteNonQuery();
            }
        ...
        protected void GetContainer()
        {
            ...
            {
                con.Open();
                string qry = "SELECT  isnull(max([ContainerId])+1,1)  FROM Delivery";
                SqlCommand cmd1 = new SqlCommand(qry, con);
                using (SqlDataAdapter da = new SqlDataAdapter(cmd1))
                {
                    DataTable dt = new DataTable();
        ...
        protected void FillGrid()
        {
            ...
            {
                con.Open();
                string qry = "SELECT  *  FROM Delivery where GRN='" + txtGRN.Text + "' order by CreatedDate";
                SqlCommand cmd1 = new SqlCommand(qry, con);
                using (SqlDataAdapter da = new SqlDataAdapter(cmd1))
                {
                    DataTable dt = new DataTable();
                    ...
                    grdScans.DataBind();
                    divHeader.InnerText = "Delivery Process - Total Scans: " + dt.Rows.Count;
                }
            }
        }
        ...
        protected List<string> FillHU()
        {
            ...
            {
                con.Open();
                string qry = "SELECT  HU  FROM Delivery where GRN='" + txtGRN.Text + "' order by CreatedDate";
                SqlCommand cmd1 = new SqlCommand(qry, con);
                using (SqlDataAdapter da = new SqlDataAdapter(cmd1))
                {
                    DataTable dt = new DataTable();
        ...
        private bool CheckGRN()
        {
           ...
           // txtDate.Text = DateTime.Now.ToString("dd/MMM/yyyy");
            ...
            {
                con.Open();
                string qry = "select GRN FROM Delivery where GRN ='" + txtGRN.Text + "'";
                SqlCommand cmd1 = new SqlCommand(qry, con);
                using (SqlDataAdapter da = new SqlDataAdapter(cmd1))
                {
                    DataTable dt = new DataTable();
        ...
        protected void CheckIncomplete()
        {
            ...
            {
                con.Open();
                string qry = "SELECT  *  FROM Delivery where Completed=0 and Loginname='" + Session["LoginId"].ToString() + "' order by DateTimeofScan desc";
                SqlCommand cmd1 = new SqlCommand(qry, con);
                using (SqlDataAdapter da = new SqlDataAdapter(cmd1))
                {
                    DataTable dt = new DataTable();
                   ...
                   if (dt.Rows.Count>0)
                    {
                        string redirectUrl = "DeliveryProcess.aspx?id=" + dt.Rows[0]["GRN"].ToString(); // The URL to open in a new tab
        ...
        protected void BindIncomplete(string GRN)
        {
            ...
            {
                con.Open();
                string qry = "SELECT  *  FROM Delivery where Completed=0 and GRN='" + GRN + "' order by DateTimeofScan";
                SqlCommand cmd1 = new SqlCommand(qry, con);
                using (SqlDataAdapter da = new SqlDataAdapter(cmd1))
                {
                    DataTable dt = new DataTable();
        ...
        private bool checkHU()
        {
            ...
            {
                con.Open();
                string qry = "Select * from Delivery where HU='" + txtHU.Text + "' and Isnull(Returned,0)=0";
                SqlCommand cmd1 = new SqlCommand(qry, con);
                using (SqlDataAdapter da = new SqlDataAdapter(cmd1))
                {
                    DataTable dt = new DataTable();
        ...
        protected void btnBack_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                ...
                string qry = "Delete  from Delivery where GRN='" + txtGRN.Text + "' and HU not in(select HU from WarehouseProcess)";
                SqlCommand cmd1 = new SqlCommand(qry, con);
        ...
        protected void btnCancel_Click1(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                ...
                cmd1.ExecuteNonQuery();
                Response.Redirect("DeliveryProcess.aspx");
                // ddlBranch.da
