<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PickSlip.aspx.cs" Inherits="LTG.PickSlip" %>
                                     ...
                                     <table style="width:100%">
                                         <tr>
                                             <td style="text-align:left;width:100%;vertical-align:top;">
                                                 <span style="font-size:x-large;font-weight: bold;">PICK SLIP</span></td>
                                                 <td style="text-align:left;width:100%;vertical-align:top;">
                                                 ...
                                                 <table style="width:100%;">
                                                     <tr>
                                                         ...
                                                         <td style="text-align:right;">
                                                             <span style="font-size:12px;font-weight:bold;">Total Qty Of HU Picked:   </span><asp:Label ID="lblTotal" runat="server" Font-Size="X-Large" Font-Bold="true"></asp:Label>
                                                         </td>
                                                     </tr>
                                                 </table>
                                                 </td> </tr>
...
<td style="vertical-align:top;" colspan="2">
    <asp:GridView ID="grdOutBound" runat="server" HeaderStyle-CssClass="heading" ShowFooter="true" ShowHeaderWhenEmpty="true" OnRowDataBound="grdOutBound_RowDataBound" AutoGenerateColumns="False" Width="100%">
        <Columns>
            ...
            <asp:BoundField DataField="FromBinLocation" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" HeaderText="From Bin Location"  HeaderStyle-Width="15%" />
            <asp:BoundField DataField="BinName" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" HeaderText="Default Bin"  HeaderStyle-Width="15%" />
