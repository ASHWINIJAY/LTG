<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="BarcodeRePrint.aspx.cs" Inherits="LTG.BarcodeRePrint" %>
          ...
          <div class="card">
           ...
           <section class="section error-404 d-flex flex-column align-items-center justify-content-center">
                <div class="row">
                     ...
                     <asp:TextBox id="txtSearchContainer" placeholder="Enter GRN to search" runat="server" ValidationGroup="TimeSlot21" AutoPostBack="true" OnTextChanged="txtSearchContainer_TextChanged"  ClientIDMode="Static" style="padding-top: 14px;" Width="70%"></asp:TextBox>
        ...
        <div class="col">
         ...
         <!-- End Recent Activity -->
             <div class="card" id="divScan" visible="true" runat="server">
               ...
               <div class="card-title" id="divHeader" runat="server" style="text-align:center;background-color: #4090ce;color:white">BarCode Reprint</div>
           <div class="section error-404 d-flex flex-column align-items-center justify-content-center">
                <div class="row">
                    <div class="col-12">
                      <label for="txtBin" class="form-label">Type or Browse GRN #</label>
                     <asp:TextBox id="txtBin" runat="server" ValidationGroup="TimeSlot" Text=""  ClientIDMode="Static" class="form-control"></asp:TextBox>
                        <asp:RequiredFieldValidator runat="server" id="RequiredFieldValidator3" controltovalidate="txtBin" ErrorMessage="Please type GRN" ForeColor="OrangeRed" />
                    </div>
                   
                     <div class="col-12">
                         <asp:Button ID="btnBrowse" class="btn btn-primary" OnClick="btnBrowse_Click" ValidationGroup="2" Text="Browse GRN From List" runat="server" />
                       </div>
